...
(function (RPA) {
  ...
  function updateOverridesCount() {
    ...
    el('vw-overrides-count').textContent =
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    overridesFilter = RPA.initRowFilter('vw-overrides-body', {
      searchId: 'vw-override-search',
      pendingId: 'vw-override-pending',
